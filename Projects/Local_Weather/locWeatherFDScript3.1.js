...
$(document).ready(function() {
  ...
  function getWeather(position) {
    ...
    $.getJSON(link, function(data) {
      ...
      feels_f =   data.current.feelslike_f.toFixed(1);
      feels_c =   data.current.feelslike_c.toFixed(1);
      ...
      // display current conditions in Fahrenheit 
      function currentCondFahr() {
        $("#temper").html("Temperature: " + temp_f + "\xB0 F <br> Feels like : " + feels_f + "\xB0 F");
        $("#wind").html("Winds from the " + wind_d + "<br> @ " + wind_m + " miles per hour");
        $(".btn-default").html("Convert to <br> Celcius <br> \xB0 " + measure);
      }  

      // display current conditions in Celcius
      function currentCondCelc() {
        $("#temper").html("Temperature: " + temp_c + "\xB0 C <br> It feels like : " + feels_c + "\xB0 C");
        $("#wind").html("Winds from the " + wind_d + "<br> @ " + wind_k + " kilometers per hour");
        $(".btn-default").html("Convert to <br> Farhenheit <br> \xB0" + measure);
      }

      // retreive and display 5-day forecast measurements in Fahrenheit
      function forecastFahr() {
        ...
        for (var i = 0; i < data.forecast.forecastday.length; i++) {
          ...
          for_high_F = data.forecast.forecastday[i].day.maxtemp_f.toFixed(1);
          for_low_F = data.forecast.forecastday[i].day.mintemp_f.toFixed(1);
          ...
          $(".forecast").append("<div class = 'forDay'><h3>" +for_day+ "</h3>" +
                                "<hr class = 'smallLine'>"+
      ...
      // retreive and display 5-day forecast measurements in Celcius
      function forecastCel() {
        ...
        for (var i = 0; i < data.forecast.forecastday.length; i++) {
          ...
          for_sunrise = data.forecast.forecastday[i].astro.sunrise;
          for_sunset =  data.forecast.forecastday[i].astro.sunset;
          for_high_C =  data.forecast.forecastday[i].day.maxtemp_c.toFixed(1);
          for_low_C =   data.forecast.forecastday[i].day.mintemp_c.toFixed(1);
          for_cond =    data.forecast.forecastday[i].day.condition.text;
          for_humid =   data.forecast.forecastday[i].day.avghumidity;
      ...
      function hourlyFahr() {
        ...
        for (var i = 0; i < 12; i++) {
          ...
          hour_temp_F =   data.forecast.forecastday["0"].hour[i].temp_f.toFixed(1);
          hour_wind_F =   data.forecast.forecastday["0"].hour[i].wind_mph.toFixed(1);
          ...
          $(".left").append("<div class = 'content'>"+"<div class = 'timeStamp'><h4 class ='hourTime'>" +hour+" AM</h4><div class = 'tempRep'><p>Temp: " +hour_temp_F + degree+" F</p></div></div>"+"<div class = 'report'>"+ hour_cond+ "<br/> "+ hour_windDir + " winds @ " + hour_wind_F + " mph</div></div>");
        }
        ...
        for (var i = 12; i < 24; i++) {
          ...
          var minute = hour_time.getMinutes().toFixed(2);

           if (hour>12) {
            hour = hour - 12;
          }

          $(".right").append("<div class = 'content'>"+"<div class = 'timeStamp'><h4 class ='hourTime'>" +hour+" PM</h4><div class = 'tempRep'><p>Temp: " +hour_temp_F + degree+" F</p></div></div>"+"<div class = 'report'>"+ hour_cond+ "<br/> "+ hour_windDir + " winds @ " + hour_wind_F + " mph</div></div>");
        }
      }
      ...
      function hourlyCelc() {
        ...
        for (var i = 0; i < 12; i++) {
          ...
          hour_time =     data.forecast.forecastday["0"].hour[i].time;
          hour_cond =     data.forecast.forecastday["0"].hour[i].condition.text;
          hour_temp_C =   data.forecast.forecastday["0"].hour[i].temp_c.toFixed(1);
          hour_wind_C =   data.forecast.forecastday["0"].hour[i].wind_kph.toFixed(1);
          hour_windDir =  data.forecast.forecastday["0"].hour[i].wind_dir;
          hour_humid =    data.forecast.forecastday["0"].hour[i].humidity;
          ...
          $(".left").append("<div class = 'content'>"+"<div class = 'timeStamp'><h4 class ='hourTime'>" +hour+" AM</h4><div class = 'tempRep'><p>Temp: " +hour_temp_C + degree+" C</p></div></div>"+"<div class = 'report'>"+ hour_cond+ "<br/> "+ hour_windDir + " winds @ " + hour_wind_C + " kph</div></div>");
        }
        ...
        for (var i = 12; i < 24; i++) {
          ...
          $(".right").append("<div class = 'content'>"+"<div class = 'timeStamp'><h4 class ='hourTime'>" +hour+" PM</h4><div class = 'tempRep'><p>Temp: " +hour_temp_C + degree+" C</p></div></div>"+"<div class = 'report'>"+ hour_cond+ "<br/> "+ hour_windDir + " winds @ " + hour_wind_C + " kph</div></div>");
        }
